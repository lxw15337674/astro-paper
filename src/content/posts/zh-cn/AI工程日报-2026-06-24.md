...
这次发布的变化点很明确：`workflow-harness` 新增了面向 durable harness agent execution 的工作流工具，同时配套更新了 `@ai-sdk/harness@1.0.0-beta.22`。对 AI 工程团队来说，这不是单纯的版本递增，而是把 Agent 从“单次调用脚本”推进到“可持续执行、可恢复、可编排”的工程形态，尤其适合长链路任务、需要状态保存的多步调用，以及带人工介入节点的流程。
